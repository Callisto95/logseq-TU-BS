...
- Körper aus Matrizen
  ...
  collapsed:: true
	- Körper:
		- $(K,+)$ ist eine abelsche Gruppe (neutrales Element: $e=\underline{0}loneqq\begin{bmatrix}0 & 0\\ 0 & 0\end{bmatrix}$)
		- Distributivgesetz gilt
		- $(K,\cdot)$ ist ein Monoid (neurales Element $e=\underline{1}loneqq\begin{bmatrix}1 & 0\\ 0 & 1\end{bmatrix}$)
