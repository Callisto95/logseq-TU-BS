	...
	- Beweis
	  collapsed:: true
		- "=>"
			...
			- zZ: $a\in A$
			- dafür reicht: $x\in\mathbb{R}\setminus A\Rightarrow x\neq a$
			- zu $x\in\mathbb{R}\setminus A$ gibt es ein $s>0$ mit $\mathbb{B}_{s}\left(x\right)\cap A=\varnothing$
...
- Satz:
	...
	- Beweis
		...
		- "<="
			...
			- [[Bolzano-Weierstraß]] => es gibt eine Teilfolge $\left(a_{\tau_{k}}\right)\subseteq\left(a_{k}\right)$ und ein $a\in\mathbb{R}$ mit $a_{\tau_{k}}\longrightarrow{}_{k\rightarrow\infty}a$
