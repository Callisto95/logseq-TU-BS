...
- $$\exists^1\xi\in\mathbb{R}:\bigcap_{k\in\mathbb{N}}I_{k}=\left\lbrace x\in\mathbb{R}\mid\forall k\in\mathbb{N}:x\in I_{k}\right\rbrace=\left\lbrace\xi\right\rbrace$$
